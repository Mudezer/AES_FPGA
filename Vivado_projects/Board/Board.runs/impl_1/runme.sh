...
HD_PWD='C:/Users/yohku/Documents/ULB/Digital_Archi/AES_FPGA/Vivado_projects/Board/Board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log notremaitreatous.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source notremaitreatous.tcl -notrace

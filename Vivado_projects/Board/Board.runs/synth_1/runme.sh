...
HD_PWD='C:/Users/yohku/Documents/ULB/Digital_Archi/AES_FPGA/Vivado_projects/Board/Board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log notremaitreatous.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source notremaitreatous.tcl

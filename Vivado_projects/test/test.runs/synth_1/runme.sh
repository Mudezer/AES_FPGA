...
HD_PWD='C:/Users/yohku/Documents/ULB/Digital_Archi/AES_FPGA/Vivado_projects/test/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MatrixToVector_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MatrixToVector_tb.tcl
